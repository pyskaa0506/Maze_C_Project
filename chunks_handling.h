...
void txt_file_to_bin_chunks(char *filepath, int16_t col, int16_t row, int16_t chunk_row_size); //function that reads a txt file and writes its content to multiple bin files
